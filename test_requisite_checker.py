...
class Checker_Test(unittest.TestCase):
    ...
    def test_real_program(self):
        self.assertTrue(self.checkr.check(self.real_prog))

    def test_fake_program(self):
        self.assertFalse(self.checkr.check(self.fake_prog))

    def test_real_module(self):
        self.assertTrue(self.checkr.check(self.real_mod))

    def test_fake_module(self):
        self.assertFalse(self.checkr.check(self.fake_mod))
