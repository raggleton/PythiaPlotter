...
import unittest
import math
from pythiaplotter.parsers.event_classes import convert_px_py_pz_e_m


class Converter_Test(unittest.TestCase):

    def test_px(self):
        pt, eta, phi = convert_px_py_pz_e_m(1, 0, 0)
    ...
    def test_py(self):
        pt, eta, phi = convert_px_py_pz_e_m(0, 1, 0)
    ...
    def test_pz(self):
        pt, eta, phi = convert_px_py_pz_e_m(0, 0, 1)
    ...
    def test_pxpy(self):
        pt, eta, phi = convert_px_py_pz_e_m(1, 1, 0)
